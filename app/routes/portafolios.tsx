...
export default function PortafoliosPage() {
  ...
  return (
    <section>
      ...
      <div className="relative top-[-2.5rem] overflow-hidden rounded-[20px_20px_0_0] bg-[linear-gradient(199deg,#9E5CFC_5.17%,#6246F8_50%,#A394FD_94.83%)] p-[var(--general-x-padding)]">
        <img
          src={bg}
          alt="bg"
